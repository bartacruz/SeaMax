...
#     left.add("/fdm/jsbsim/hydro/planing-lift-lbs");
    ...
    #left.add("/fdm/jsbsim/external_reactions/hydro-roll/magnitude-lbsft");
    left.add("/fdm/jsbsim/hydro/roll-damp-lbsft");
    left.add("/fdm/jsbsim/hydro/yaw-damp-lbsft");
    left.add("/fdm/jsbsim/velocities/u-fps");
    #left.add("/fdm/jsbsim/hydro/Z/force-lbs");
    left.add("/fdm/jsbsim/hydro/hull-drag-lbsft");
...
#     left.add("/fdm/jsbsim/hydro/roll-moment-lbsft");
    ...
    right.add("/fdm/jsbsim/contact/unit[3]/compression-ft");
    right.add("/fdm/jsbsim/contact/unit[4]/compression-ft");
    right.add("/fdm/jsbsim/contact/unit[5]/compression-ft");
    right.add("/fdm/jsbsim/contact/unit[6]/compression-ft");
    right.add("/fdm/jsbsim/contact/unit[7]/compression-ft");
    right.add("/fdm/jsbsim/contact/unit[8]/compression-ft");
    right.add("/fdm/jsbsim/hydro/compression-lbs");

    right.add("/fdm/jsbsim/fcs/rudder-pos-rad");
    right.add("/fdm/jsbsim/hydro/yaw-damp");
