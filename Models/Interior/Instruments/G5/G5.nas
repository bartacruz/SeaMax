...
var base_path = "Aircraft/SeaMax/Models/Interior/Instruments/G5/";
...
var hdg		=	props.globals.getNode("/orientation/heading-magnetic-deg",					1);
...
var ar_speed	=	props.globals.getNode("/instrumentation/airspeed-indicator/indicated-speed-kt",	1);
var ap_sw	=	props.globals.getNode("/autopilot/serviceable",1);
var ap_alt	=	props.globals.getNode("/autopilot/settings/target-altitude-ft",1);
var ap_vs	=	props.globals.getNode("/autopilot/settings/vertical-speed-fpm",1);
var ap_on	=	props.globals.getNode("/autopilot/annunciators/ap",									1);
var ap_vert	=	props.globals.getNode("/autopilot/annunciators/altitude",									1);
var ap_lat	=	props.globals.getNode("/autopilot/annunciators/heading",									1);
...
var power_btn = props.globals.getNode("/instrumentation/G5/power-btn",0,"BOOL");
